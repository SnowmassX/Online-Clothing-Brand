...
<body>
    ...
    <main id="main">
        ...
        <div class="form-container" id="formContainer">
            ...
            <form method="POST" action="../controller/registrationCheck.php" id="registrationForm" enctype="multipart/form-data">
                ...
                <input type="file" name="image" id="image" alt="image">
                <input type="submit" name="submit" id="submit" value="Register" onclick="validateForm()">
            </form>
